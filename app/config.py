...
class Settings(BaseSettings):
    ...
    RATE_LIMIT_PROCESSING_PER_MINUTE: int = 20
    RATE_LIMIT_EXPENSIVE_READS_PER_MINUTE: int = 30
    RATE_LIMIT_RELATIONSHIP_DETECTION_PER_MINUTE: int = 12
    HARD_DAILY_MAX_UPLOADS: int = 250
    HARD_DAILY_MAX_PROCESSING_JOBS: int = 400
    HARD_DAILY_MAX_FAILED_PROCESSING_RETRIES: int = 60
