...
describe('admin email pages',()=>{
  it('renders providers and templates', async()=>{render(<MemoryRouter><AdminEmailSettingsPage/></MemoryRouter>); expect(await screen.findByText('resend')).toBeInTheDocument(); expect(screen.getByText('sendgrid')).toBeInTheDocument();});
