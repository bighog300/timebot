...
import { setActiveWorkspaceId } from '@/services/workspace';
...
export function DivorceSetupPage() {
  ...
  return <div className='space-y-3'>
    ...
    <button onClick={async ()=>{const ws=await api.createDivorceWorkspace({case_title: caseTitle, jurisdiction, current_stage:'considering divorce', children_involved:false, financial_disclosure_started:false, lawyer_involved:false}); setActiveWorkspaceId(ws.id); navigate('/divorce');}}>Create</button>
