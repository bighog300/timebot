...
export interface PromptTemplate { id: string; prompt_type: PromptTemplateType; name: string; content: string; version: number; is_active: boolean; provider: "openai"|"gemini"; model: string; temperature: number; max_tokens: number; top_p: number; enabled: boolean; is_default: boolean; created_at: string; updated_at: string; }
export interface PromptTemplateCreateRequest { prompt_type: PromptTemplateType; name: string; content: string; provider: "openai"|"gemini"; model: string; temperature: number; max_tokens: number; top_p: number; enabled: boolean; is_default: boolean; }
